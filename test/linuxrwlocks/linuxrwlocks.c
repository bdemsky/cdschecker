...
inline static call_id_t Write_Trylock_id(thread_id_t __TID__) {
call_id_t __ID__ = 0;
return __ID__;
}
...
inline static call_id_t Read_Trylock_id(thread_id_t __TID__) {
call_id_t __ID__ = 0;
return __ID__;
}
...
inline static call_id_t Write_Lock_id(thread_id_t __TID__) {
call_id_t __ID__ = 0;
return __ID__;
}
...
inline static call_id_t Write_Unlock_id(thread_id_t __TID__) {
call_id_t __ID__ = 0;
return __ID__;
}
...
inline static call_id_t Read_Unlock_id(thread_id_t __TID__) {
call_id_t __ID__ = 0;
return __ID__;
}
...
inline static call_id_t Read_Lock_id(thread_id_t __TID__) {
call_id_t __ID__ = 0;
return __ID__;
}
...
hbConditionInit0->interface_num_before = 5;
...
hbConditionInit1->interface_num_before = 5;
...
hbConditionInit2->interface_num_after = 0;
...
hbConditionInit3->interface_num_after = 2;
...
if ( priorvalue > 0 ) {
/* Automatically generated code for commit point define check: Read_Trylock_Succ_Point */
...
/* Automatically generated code for commit point define check: Read_Trylock_Fail_Point */
...
if ( priorvalue == RW_LOCK_BIAS ) {
/* Automatically generated code for commit point define check: Write_Trylock_Succ_Point */
...
/* Automatically generated code for commit point define check: Write_Trylock_Fail_Point */
...
for ( i = 0 ; i < 2 ; i ++ ) {
if ( ( i % 2 ) == 0 ) {
read_lock ( & mylock ) ; load_32 ( & shareddata ) ; read_unlock ( & mylock ) ; }
else {
write_lock ( & mylock ) ;
