...
inline static call_id_t Steal_id() {
...
inline static bool Steal_check_action(void *info, call_id_t __ID__) {
bool check_passed;
...
inline static call_id_t Take_id() {
...
inline static bool Take_check_action(void *info, call_id_t __ID__) {
bool check_passed;
...
inline static call_id_t Push_id() {
...
inline static bool Push_check_action(void *info, call_id_t __ID__) {
bool check_passed;
...
hbConditionInit1->interface_num_after = 0;
