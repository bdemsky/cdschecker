...
static inline void set_count ( pointer * p , unsigned int val ) {
* p = ( * p & ~ COUNT_MASK ) | ( ( pointer ) val << 32 ) ;
}
static inline void set_ptr ( pointer * p , unsigned int val ) {
* p = ( * p & ~ PTR_MASK ) | val ;
}
static inline unsigned int get_count ( pointer p ) {
return ( p & COUNT_MASK ) >> 32 ;
}
static inline unsigned int get_ptr ( pointer p ) {
return p & PTR_MASK ;
}
typedef struct node {
unsigned int value ;
...
inline static call_id_t Dequeue_id() {
...
inline static bool Dequeue_check_action(void *info, call_id_t __ID__) {
bool check_passed;
...
inline static call_id_t Enqueue_id() {
...
inline static bool Enqueue_check_action(void *info, call_id_t __ID__) {
bool check_passed;
...
hbConditionInit0->interface_num_before = 0;
